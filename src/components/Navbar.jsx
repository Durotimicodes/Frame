...
const handleClick = () => setNav(!nav)
  ...
  return (
    ...
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4'>
        ...
        <li className='w-[160px] h-[60px] justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#EEBC1D]'><a href='/personal-portfolio/src/assests/projects/Edmond Fagbuyi Resume.pdf' className='flex justify-between items-center w-full text-gray-300 font-bold'>Resume <BsFillPersonLinesFill size={30}/></a></li>
        </ul>
